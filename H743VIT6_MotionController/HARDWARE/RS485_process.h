...
#define USARTx                          UART5                // 串口端口
#define USARTx_CLK_ENABLE()             __HAL_RCC_UART8_CLK_ENABLE()
#define GPIO_USARTx_TX_GPIO_PORT         GPIOEB                 // TX引脚 GPIOA9
#define GPIO_USARTx_TX_GPIO_PIN          GPIO_PIN_13
#define GPIO_USARTx_RX_GPIO_PORT         GPIOB                 // RX引脚 GPIOA10
#define GPIO_USARTx_RX_GPIO_PIN          GPIO_PIN_12
